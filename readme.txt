...
* New product endpoint to make sure products are offline (GTIN based)
...
* Compatible with new WordPress version 6.9

#### Bugfixes

* When a price is empty, set 0 value for product variant option
