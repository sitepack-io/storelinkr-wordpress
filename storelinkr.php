...
Description: Stop manual work: the all-in-one platform for complete webshop automation. Integrate with marketplaces, product feeds, and suppliers.
Version: 2.5.3
Author: StoreLinkr
...
define('STORELINKR_VERSION', '2.5.3');
